                            ...
                            i_enable(PB_1),button(PA_10),i_des(PA_4),uw(4*2048,16),spi(PA_12, PA_11, PA_1),imu(spi, PB_0)
{
    ...
    /* *** AUFGABEN *** :
    1.1, 1.2, 1.3    */
    ax2ax = LinearCharacteristics( -16100, 16700, -9.81, 9.81);
    ay2ay = LinearCharacteristics( -16700, 16100, -9.81, 9.81);
    ...
    fil_ax = IIR_filter( 1, Ts, 1);
    fil_ay = IIR_filter( 1, Ts, 1);
    fil_gz = IIR_filter( 1, Ts, 1);
}
// Deconstructor
